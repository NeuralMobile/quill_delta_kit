...
void main() {
  ...
  group('round-trip', () {
    test('plain', () => rt([{'insert': 'hello\n'}]));
    test('bold', () => rt([
          {'insert': 'a', 'attributes': {'bold': true}},
          {'insert': '\n'}
        ]));
    test('multi-attr', () => rt([
          {'insert': 'x', 'attributes': {'bold': true, 'italic': true, 'underline': true}},
          {'insert': '\n'}
        ]));
    test('color', () => rt([
    ...
    test('link', () => rt([
          {'insert': 'a', 'attributes': {'link': 'https://example.com'}},
          {'insert': '\n'}
        ]));
    test('h1', () => rt([
          {'insert': 'x'},
    ...
    test('mention', () => rt([
          {'insert': {'mention': {'denotationChar': '@', 'id': '1', 'value': 'X'}}},
          {'insert': '\n'}
        ]));
    test('script super', () => rt([
          {'insert': 'x', 'attributes': {'script': 'super'}},
          {'insert': '\n'}
        ]));
    test('mixed inline + block + embed', () => rt([
          {'insert': 'before '},
