...
final Map<String, List<Map<String, dynamic>>> fixtures = {
  ...
  'Color + size': [
    ...
    {'insert': 'on yellow', 'attributes': {'background': '#ffff00'}},
    {'insert': ' '},
    {'insert': 'big', 'attributes': {'size': 'large'}},
    {'insert': ' '},
    {'insert': 'huge', 'attributes': {'size': 'huge'}},
    {'insert': ' '},
    {'insert': '24px', 'attributes': {'size': '24'}},
    {'insert': '\n'},
  ],
  'Headings': [
    {'insert': 'H1'},
  ...
  'Link + Script': [
    {'insert': 'Visit '},
    {'insert': 'flutter.dev', 'attributes': {'link': 'https://flutter.dev'}},
    {'insert': '. Water is H'},
...
const Map<String, String> htmlFixtures = {
  'Quill': '<h1>Title</h1><p>Plain <strong>bold</strong> <em>italic</em>.</p>'
  ...
  'ProseMirror': '<p><strong><em>bold italic</em></strong></p>'
